      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: () => {
            ...
            Alert.alert(
              'Success',
              'Job marked as applied! You can now proceed with the application process.'
            );
          },
        },
      ]
      ...
      <View style={styles.filters}>
          ...
          <View style={styles.filterButtons}>
            ...
            >
              <Text
                style={[
                  styles.filterText,
                  filterBy === 'all' && styles.activeFilterText,
                ]}
              >
            ...
            <TouchableOpacity
              style={[
                styles.filterButton,
                filterBy === 'not-applied' && styles.activeFilterButton,
              ]}
            ...
            >
              <Text
                style={[
                  styles.filterText,
                  filterBy === 'not-applied' && styles.activeFilterText,
                ]}
              >
                Not Applied (
                {state.savedJobs.filter((job) => !job.applied).length})
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[
                styles.filterButton,
                filterBy === 'applied' && styles.activeFilterButton,
              ]}
            ...
            >
              <Text
                style={[
                  styles.filterText,
                  filterBy === 'applied' && styles.activeFilterText,
                ]}
              >
        ...
        <View style={styles.sortRow}>
          ...
          <TouchableOpacity
            style={[
              styles.sortButton,
              sortBy === 'match' && styles.activeSortButton,
            ]}
          ...
          <TouchableOpacity
            style={[
              styles.sortButton,
              sortBy === 'salary' && styles.activeSortButton,
            ]}
          ...
          >
            <Text
              style={[
                styles.sortText,
                sortBy === 'salary' && styles.activeSortText,
              ]}
            >
              Salary
            </Text>
      ...
      {sortedJobs.length === 0 ? (
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <SavedJobCard
              job={item}
              onRemove={() => handleRemoveJob(item.id)} // ✅ This is correct
